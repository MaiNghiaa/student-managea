        ...
        <div class="authentication-inner">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <!-- /Logo -->
              <form id="formAuthentication" class="mb-3" action="{{route('admin.addNewDepartment')}}" method="post">
                @csrf
                {{-- {{dd($student)}}; --}}
                <div class="mb-3">
                  <label for="id" class="form-label">Id Department</label>
                  <input type="text" class="form-control" id="id" name="id" placeholder="Enter your id" value=""/>
                </div>
                <div class="mb-3">
                ...
                <button class="btn btn-primary d-grid w-100">Thêm Mới</button>
              </form>
