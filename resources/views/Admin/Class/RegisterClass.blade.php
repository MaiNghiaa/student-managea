        ...
        <div class="authentication-inner">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <!-- /Logo -->
              <form id="formAuthentication" class="mb-3" action="{{route('admin.addNewClass')}}" method="post">
                @csrf
                {{-- {{dd($Classroom->id)}}; --}}
                <div class="mb-3">
                  <label for="id" class="form-label">Id Classroom</label>
                  <input type="number" class="form-control" id="classroom_id" name="classroom_id" placeholder="Enter your id"/>
                </div>
                <div class="mb-3">
                  <label for="Classroom" class="form-label">Classroom</label>
                  <input type="text" class="form-control" id="Classroom" name="Classroom" placeholder="Enter your Classroom" required/>
                </div>
                <div class="mb-3">
