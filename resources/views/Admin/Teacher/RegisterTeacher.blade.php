...
select#Gender {
  border: 1px solid #ccc;
        ...
        <div class="authentication-inner">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <!-- /Logo -->
              <form id="formAuthentication" class="mb-3" action="{{route('admin.addNewTeacher')}}" method="POST">
                @csrf
                <div class="mb-3">
                ...
                <div class="mb-3">
                  ...
                  <input type="date" class="form-control" id="dob" name="dob" placeholder="Your Birthday" required/>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                  ...
                  <input type="number" class="form-control" id="Phone_number" name="Phone_number" placeholder="Enter your Phone_number" required/>
                </div>
                <div class="mb-3">
    ...
    <input type="checkbox" name="specialized[]" value="{{ $classroom->id }}">
        {{ $classroom->classroom }}
    <br />
@endforeach
                </div>
