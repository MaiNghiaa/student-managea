      ...
      <tbody>
        ...
        {{-- {{dd($teacher->classroom_teacher())}} --}}
          <tr>
            ...
            <td>
                ...
                @foreach ($classrooms as $classroom)
                  @foreach ($teachers_classrooms as $teacher_classroom)
                    @if ($teacher_classroom->teacher_id == $teacher->id && $teacher_classroom->classroom_id == $classroom->id)
            ...
            <td>
              <form class="form_del" action="{{ route('deleteTeacher', $teacher->id) }}" method="POST">
                @csrf
                @method('DELETE')
                ...
                <button class="btn btn-xs btn-primary" style="margin-left:10px;padding:0;"><a href="{{route('editTeacher',$teacher->id)}}" style="color: #fff;
                  padding: 20px 20px;
                  font-size: 0.75rem;
                  line-height: 36px;
              }">
