        ...
        <div class="authentication-inner">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <!-- /Logo -->
              <form id="formAuthentication" class="mb-3" action="{{route('updateStudent',$student->Student_id)}}" method="post">
                @csrf
        @method('PUT')
                {{-- {{dd($student)}}; --}}
                <div class="mb-3">
                  <label for="id" class="form-label">Id Name</label>
                  <input type="text" class="form-control" id="id" name="id" placeholder="Enter your id" value="{{$student->Student_id}}"/>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                  ...
                  <input type="date" class="form-control" id="dob" name="dob" placeholder="Your Birthday" required value="{{$student->Date_of_birth}}"/>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control" id="Address" name="Address" placeholder="Enter your Address" required value="{{$student->Address}}"/>
                </div>
                <div class="mb-3">
                  <label for="Phone_number" class="form-label">Phone Number</label>
                  <input type="number" class="form-control" id="Phone_number" name="Phone_number" placeholder="Enter your Phone_number" required value="{{$student->Phone_number}}"/>
                </div>
                <div class="mb-3">
                  <label for="email" class="form-label">Email</label>
                  <input type="text" class="form-control" id="email" name="email" placeholder="Enter your email" required value="{{$student->Email}}"/>
                </div>
