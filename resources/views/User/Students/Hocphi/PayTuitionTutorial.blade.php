...
.another_info {
  ...
  <!-- / Menu -->
    ...
    <div class="main_content">
      ...
      <h2 class="line">Hướng dẫn nộp Học Phí </h2>
...
<div class="accordion accordion-flush" id="accordionFlushExample">
    <div class="accordion-item">
      ...
      <div id="flush-collapseOne" class="accordion-collapse collapse" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
        <div class="accordion-body">
          <img src="{{asset('Qr/z4427218569434_14ecfe74265d8f8bfc20d0edd1b8b0c0.jpg')}}" alt="" style="width:200px; height:300px; object-fit:cover">
    ...
    <div class="accordion-item">
      ...
      <div id="flush-collapseTwo" class="accordion-collapse collapse" aria-labelledby="flush-headingTwo" data-bs-parent="#accordionFlushExample">
        <div class="accordion-body">
          <img src="{{asset('Qr/z4427218963218_c126c6cffe740b3983ee82290d95460e.jpg')}}" alt="" style="width:200px; height:300px; object-fit:cover">
        </div>
      </div>
    </div>
    <div class="accordion-item">
      ...
      <div id="flush-collapseThree" class="accordion-collapse collapse" aria-labelledby="flush-headingThree" data-bs-parent="#accordionFlushExample">
        <div class="accordion-body">
          <img src="{{asset('Qr/z4427218971987_63bf82a34bd8218ec74356592fbec4d5.jpg')}}" alt="" style="width:200px; height:300px; object-fit:cover">
