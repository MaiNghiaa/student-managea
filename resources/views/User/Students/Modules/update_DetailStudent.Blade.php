...
<!-- Menu -->
  ...
  <!-- / Menu -->
      ...
      <div class="main_content">
        <form id="student-form" method="post"  enctype="multipart/form-data" action="{{route('user.post_Update_Student_detail',compact('studentId'))}}">
          @csrf
            <div class="form-group">
                <label for="year">Năm Vào Trường:</label>
                <input type="number" id="year" name="year" value="{{$studentfamily->year}}">
            </div>
            <div class="form-group">
                <label for="level"> Bậc đào tạo:</label>
                <input type="text" id="level" name="level" value="{{$studentfamily->level}}">
            </div>

            <div class="form-group">
                <label for="chuongtrinh">Chương trình:</label>
                <input type="text" id="chuongtrinh" name="chuongtrinh" value="{{$studentfamily->chuongtrinh}}">
            </div>

            <div class="form-group">
                <label for="highschool">Trường THPT :</label>
                <input type="text" id="highschool" name="highschool" value="{{$studentfamily->highschool}}">
            </div>
            <div class="form-group">
                <label for="Nation">Khóa :</label>
                <input type="number" id="Nation" name="Nation" value="{{$studentfamily->nation}}">
            </div>

            <div class="form-group">
                <label for="highschoolgra">Năm Tốt nghiệp cấp 3:</label>
                <input type="text" id="highschoolgra" name="highschoolgra" value="{{$studentfamily->highschoolgra}}">
            </div>

            <div class="form-group">
                <label for="CMND">Số CMND:</label>
                <input type="text" id="CMND" name="CMND" value="{{$studentfamily->CMND}}">
            </div>

            <div class="form-group">
                <label for="noicap">Nơi cấp CMND:</label>
                <input type="text" id="noicap" name="noicap" value="{{$studentfamily->Noicap}}">
            </div>

            <div class="form-group">
                <label for="fathername">Họ tên cha:</label>
                <input type="text" id="fathername" name="fathername" value="{{$studentfamily->fathername}}">
            </div>

            <div class="form-group">
                <label for="fatherbirth">Năm sinh cha:</label>
                <input type="number" id="fatherbirth" name="fatherbirth" value="{{$studentfamily->fatherbirth}}">
            </div>

            <div class="form-group">
                <label for="fatherjob">Nghề nghiệp cha:</label>
                <input type="text" id="fatherjob" name="fatherjob" value="{{$studentfamily->fatherjob}}">
            </div>

            <div class="form-group">
                <label for="fatherphone">Số điện thoại cha:</label>
                <input type="text" id="fatherphone" name="fatherphone" value="{{$studentfamily->fatherphone}}">
            </div>

            <div class="form-group">
                <label for="mothername">Họ tên mẹ:</label>
                <input type="text" id="mothername" name="mothername" value="{{$studentfamily->mothername}}">
            </div>

            <div class="form-group">
                <label for="motherbirth">Năm sinh mẹ:</label>
                <input type="number" id="motherbirth" name="motherbirth" value="{{$studentfamily->motherbirth}}">
            </div>

            <div class="form-group">
                <label for="motherjob">Nghề nghiệp mẹ:</label>
                <input type="text" id="motherjob" name="motherjob" value="{{$studentfamily->motherjob}}">
            </div>

            <div class="form-group">
                <label for="motherphone">Số điện thoại mẹ:</label>
                <input type="number" id="motherphone" name="motherphone" value="{{$studentfamily->motherphone}}">
            </div>

            <div class="form-group">
                <label for="household">Hộ khẩu thường trú:</label>
                <textarea id="household" name="household" value="{{$studentfamily->household}}"></textarea>
            </div>
