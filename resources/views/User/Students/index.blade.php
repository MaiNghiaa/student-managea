...
.another_info {
  ...
  <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <li class="menu-item">
      <a href="{{route('User.ThuBao', ['studentId' => $studentId])}}" class="menu-link">
        ...
        <li class="menu-item">
          <a href="{{route('hust.changePasswordStudent', ['studentId' => $student->id])}}" class="menu-link">
            <i class="menu-icon tf-icons bx bx-detail"></i>
      ...
      <li class="menu-item">
        <a href="{{route('user.Student.khaibaoyte', ['studentId' => $student->id])}}" class="menu-link">
          <i class="menu-icon tf-icons bx bx-detail"></i>
    ...
    <ul class="menu-inner py-1">
      <li class="menu-item">
        ...
        <ul class="menu-sub">
          <li class="menu-item">
            <a href="{{route('UserStudent.index',['studentId' => $student->id])}}" class="menu-link">
        ...
        <ul class="menu-sub">
          <li class="menu-item">
            <a href="{{route('user.Update_Student_detail', ['studentId' => $student->id])}}" class="menu-link">
      ...
      <!-- Department  -->
      <li class="menu-item">
        <a href="{{route('User.dangkyhocphan', ['studentId' => $student->id])}}" class="menu-link">
          <i class="menu-icon tf-icons bx bx-detail"></i>
          <div data-i18n="Form Layouts">Đăng ký học phần</div>
        </a>
      </li>
      <li class="menu-item">
        <a href="{{route('user.HocPhan', ['studentId' => $student->id])}}" class="menu-link">
          <i class="menu-icon tf-icons bx bx-detail"></i>
      ...
      <li class="menu-item">
        <a href="{{route('FAQ.student', ['studentId' => $student->id])}}" class="menu-link">
          <i class="menu-icon tf-icons bx bx-dock-top"></i>
      ...
      <li class="menu-item">
        <a href="{{route('User.StudentsHocphi', $student->id)}}" class="menu-link">
          <i class="menu-icon tf-icons bx bx-dock-top"></i>
          <div data-i18n="Account Settings">Học Phí</div>
        </a>
      </li>
      <li class="menu-item">
        <a href="{{route('User.Paytutiontutorial', $student->id)}}" class="menu-link">
          <i class="menu-icon tf-icons bx bx-dock-top"></i>
  ...
  <!-- / Menu -->
    ...
    <div class="main_content">
      ...
      <h2 class="line">Thông tin sinh viên </h2>
      <div class="info_student">
        ...
        <div class="content">
          <div class="content_col_1">
            ...
            <p class="text" name="name">{{$student->Full_name}}</p>
          </div>
            <div class="row-5">
          ...
          <div class="content_col_2">
            ...
            <div class="row-5">
              ...
              <p class="text" name="email">{{$student->Email}}</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="another_info">
        <div class="content_col_1_family">
          ...
          <p class="text" name="level">{{$student->Address}}</p>
        </div>
          <div class="row-5">
        ...
        <div class="content_col_1_family">
          ...
          <div class="row-5">
            ...
            <p class="text" name="email">{{$student->Phone_number}}</p>
          </div>
          <div class="row-5">
