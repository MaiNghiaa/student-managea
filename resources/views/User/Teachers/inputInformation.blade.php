...
<div class="column_2">
 ...
 <!-- / Menu -->
        ...
        <div class="main_content">
          <form id="student-form" method="post" enctype="multipart/form-data" action="{{route('detailTeacher.index',compact('teacherId'))}}"
          >
            @csrf
              <div class="form-group">
                  <label for="year">Năm Vào Trường:</label>
                  <input placeholder="2023" type="number" id="year" name="year">
              </div>
              <div class="form-group">
                  <label for="level"> Bậc đào tạo:</label>
                  <input placeholder="Đại Học" type="text" id="level" name="level">
              </div>

              <div class="form-group">
                  <label for="chuongtrinh">Chương trình:</label>
                  <input placeholder="Tiên Tiến" type="text" id="chuongtrinh" name="chuongtrinh">
              </div>

              <div class="form-group">
                  <label for="highschool">Trường THPT :</label>
                  <input placeholder="VD : Hồng Bàng - Hải Phòng" type="text" id="highschool" name="highschool">
              </div>
              <div class="form-group">
                  <label for="Nation">Khóa :</label>
                  <input placeholder="56" type="number" id="Nation" name="Nation">
              </div>

              <div class="form-group">
                  <label for="highschoolgra">Năm Tốt nghiệp cấp 3:</label>
                  <input placeholder="2021" type="text" id="highschoolgra" name="highschoolgra">
              </div>

              <div class="form-group">
                  <label for="CMND">Số CMND:</label>
                  <input placeholder="012342523487" type="text" id="CMND" name="CMND">
              </div>
              ...
              <div class="form-group">
                  ...
                  <input placeholder="" type="text" id="fathername" name="fathername">
              </div>

              <div class="form-group">
                  <label for="fatherbirth">Năm sinh cha:</label>
                  <input placeholder="" type="number" id="fatherbirth" name="fatherbirth">
              </div>

              <div class="form-group">
                  <label for="fatherjob">Nghề nghiệp cha:</label>
                  <input placeholder="" type="text" id="fatherjob" name="fatherjob">
              </div>

              <div class="form-group">
                  <label for="fatherphone">Số điện thoại cha:</label>
                  <input placeholder="" type="text" id="fatherphone" name="fatherphone">
              </div>

              <div class="form-group">
                  <label for="mothername">Họ tên mẹ:</label>
                  <input placeholder="" type="text" id="mothername" name="mothername">
              </div>
              ...
              <div class="form-group">
                  ...
                  <input id="household" name="household">
              </div>
              <label for="avatar">thêm tấm ảnh cho đẹp trai / Xinh gái</label>
