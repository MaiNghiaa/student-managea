                ...
                <tr>
                    ...
                    <td>
                        <button class="btn btn-xs btn-primary" style="margin-left:10px;padding:0;font-weight:700">
                            <a href="{{ route('User.TeacherDetailclass', ['teacherId' => $teacherId, 'classId' => $Classroom->id]) }}" style="color: #fff;padding: 20px 20px;font-size: 0.75rem;line-height: 36px;">
                                Chi Tiết
                            </a>
                        </button>
                        <button style="margin: 0 10px;">
                            <a href="{{ route('User.TeacherDiemDanh', ['teacherId' => $teacherId, 'classId' => $Classroom->id]) }}" class="btn btn-primary">Điểm danh</a>
                        </button>
                        <button>
                            <a href="{{ route('User.TeacherPoint', ['teacherId' => $teacherId, 'classId' => $Classroom->id]) }}" class="btn btn-primary">Bảng Điểm</a>
                        </button>
                    </td>
                </tr>
                @endforeach
