  ...
  <!-- / Menu -->
    ...
    <div class="main_content">
      ...
      <table>
        ...
        <tbody>
            <form action="{{route('User.TeacherUpdate_Diem', ['teacherId' => $teacherId, 'classId' => $classId])}}" method="post">
                @csrf
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="diemquatrinh[]">
      ...
      <button type="submit" class="submitchangepoint">Cập Nhật</button>
    </form>
    </div>
  </div>
</div>
